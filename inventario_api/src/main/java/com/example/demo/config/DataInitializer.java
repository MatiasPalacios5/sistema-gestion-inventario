...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        com.example.demo.model.Categoria elec = categoriaRepository.findByNombre("Electrónica")
                .orElseGet(() -> categoriaRepository.save(new com.example.demo.model.Categoria("Electrónica")));
        com.example.demo.model.Categoria herr = categoriaRepository.findByNombre("Herramientas")
                .orElseGet(() -> categoriaRepository.save(new com.example.demo.model.Categoria("Herramientas")));
        com.example.demo.model.Categoria hogar = categoriaRepository.findByNombre("Hogar")
                .orElseGet(() -> categoriaRepository.save(new com.example.demo.model.Categoria("Hogar")));
